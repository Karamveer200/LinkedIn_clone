    ...
    <>
      <Container>
        <ShareBox>
          ...
          <div>
            <button>
              <img onClick={handleClick} src="/images/photo-icon.png" alt="" />
              <span>photo</span>
            </button>

            <button>
              <img onClick={handleClick} src="/images/video-icon.png" alt="" />
              <span>Video</span>
            </button>
          ...
          {props.articles.length != 0 &&
            props.articles.map((article, key) => (
              <Article key={key}>
                ...
                <SharedImg>
                  <a>
                    {!article.shareedImg && article.video ? (
                ...
                <SocialAction>
                  <button>
                    <img onClick={IncNum} src="/images/like.png" alt="" />
                    <span>like</span>
                  </button>
                  <button>
                    <img onClick={DecNum} src="/images/dislike.png" alt="" />
                    <span>Dislike</span>
                  </button>
                  <button>
                    <a
